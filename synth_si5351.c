...
//*****************************************************************************
//
//! \defgroup synth_si4351 Frequency Synthesizer
//! \brief Driver for the Silicon Labs si5351 Frequency synthesizer
//! Interfaces the TI tiva C Launchpad with the Silicon Labs si5351 frequency
//! synthesizer
//! Files:
//!  synth_si4351.c
 ...
 *
 * \param synthEN enables or disables the synthesizer outputs
 * \param xtal_cl Crystal input load capacitance selection
 * \param regConfig register configuration generated by  ClockBuilder Desktop
 * \param outputEn Outputs to be enabled
 **/
 ...
 *
 * \param outputEn Enables the synthesizer output
 *
 ...
 *
 * \param bEnable Active low enable signal for the D flip-flop that reclocks the
 ...
 *
 * \param interruptMasks - Indicates the interrupts that are to be masked
 * Logical or of one or more of the following values:
